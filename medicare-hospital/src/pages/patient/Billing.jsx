...
//     return <span className={`badge ${statusColors[status] || ''} capitalize`}>{status}</span>;
//   };
...
//   if (loading) {
//     return <div className="text-center py-10 text-gray-600 text-xl">Loading bills...</div>;
//   }
...
//           {bills.map((bill) => (
//             <div key={bill.id} className="card bg-base-100 shadow-md p-6">
//               <div className="flex justify-between items-center border-b pb-3">
//                 <div>
//                   <h3 className="text-lg font-bold">{bill.bill_number}</h3>
...
//                 <div className="flex justify-between">
//                   <span>Discount:</span>
//                   <span className="font-medium text-red-600">-{formatCurrency(bill.discount_amount)}</span>
//                 </div>
...
//               <h2 className="text-2xl font-bold">Pay Bill</h2>
//               <button onClick={() => setSelectedBill(null)} className="btn btn-sm btn-circle btn-ghost">✕</button>
//             </div>

//             <form onSubmit={handlePaymentSubmit} className="space-y-4">
//               <div>
//                 <h4 className="font-bold">Bill Summary</h4>
//                 <p><strong>Bill Number:</strong> {selectedBill.bill_number}</p>
//                 <p><strong>Amount Due:</strong> {formatCurrency(selectedBill.final_amount)}</p>
//                 <p><strong>Due Date:</strong> {formatDate(selectedBill.due_date)}</p>
//               </div>
...
//                 <button type="button" className="btn" onClick={() => setSelectedBill(null)}>Cancel</button>
